...
using hls::sim::Byte;
extern "C" void ekf_batch(Byte<4>*, Byte<4>*, int, int, int);
extern "C" void apatb_ekf_batch_hw(volatile void * __xlx_apatb_param_data, volatile void * __xlx_apatb_param_nmeas, int __xlx_apatb_param_num_tracks) {
...
__xlx_data__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_data)[i]);
  ...
  int __xlx_size_param_data = 9800;
  int __xlx_offset_param_data = 0;
  int __xlx_offset_byte_param_data = 0*4;
  // Collect __xlx_nmeas__tmp_vec
std::vector<Byte<4>> __xlx_nmeas__tmp_vec;
for (size_t i = 0; i < 100; ++i){
__xlx_nmeas__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_nmeas)[i]);
}
  int __xlx_size_param_nmeas = 100;
  int __xlx_offset_param_nmeas = 0;
  int __xlx_offset_byte_param_nmeas = 0*4;
  // DUT call
  ekf_batch(__xlx_data__tmp_vec.data(), __xlx_nmeas__tmp_vec.data(), __xlx_offset_byte_param_data, __xlx_offset_byte_param_nmeas, __xlx_apatb_param_num_tracks);
...
// print __xlx_apatb_param_nmeas
for (size_t i = 0; i < __xlx_size_param_nmeas; ++i) {
((Byte<4>*)__xlx_apatb_param_nmeas)[i] = __xlx_nmeas__tmp_vec[__xlx_offset_param_nmeas+i];
}
}
